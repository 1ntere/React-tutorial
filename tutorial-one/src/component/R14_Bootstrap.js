...
npm i bootstrap 뒤에 추가로 @버전을 작성하지 않으면 가장 최신 버전으로 설치
만약에 특정 버전을 설치하고 싶다면
npm i bootstrap@버전
...
npm으로 인한 설치는 npm start로 시작하고 있는 패키지 실행여부와 관계없이 설치가 가능
...
npm = 상대적으로 설치 속도 느림
yarn = npm과 똑같은 패키지 관리자, npm 보다 조금 더 빠름
*/
